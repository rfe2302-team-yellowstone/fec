...
export default function FullScreenModalOne ({currentStyle, fullScreenMode, setFullScreenMode, currentFSIndex, setCurrentFSIndex, currentIndex, setCurrentIndex, changeImage, idPrefix}) {
