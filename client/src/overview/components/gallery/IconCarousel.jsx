...
export default function IconCarousel ({currentStyle, currentIndex, setCurrentIndex, changeImage, idPrefix}) {
  ...
  return (
    ...
    <div className="carousel carousel-center space-x-1 bg-transparent rounded-box mt-4 transition duration-500 w-[700] hover:overflow-visible w hover:scale-105 hover:space-x-2">
      {
