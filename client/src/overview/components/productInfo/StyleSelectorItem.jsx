...
export default function StyleSelectorItem ({i, style, currentStyle, setCurrentStyle, handleStyleChange}) {
  ...
  return (
    <div className={`avatar cursor-pointer basis-1/5 hover:scale-110 hover:drop-shadow-[0_12px_12px_rgba(0,0,0,0.25)] ${(currentStyle.name === style.name) && 'scale-110 drop-shadow-[0_8px_4px_rgba(0,0,0,0.25)]'}`} onClick={handleStyleChange} name={style.id}>
